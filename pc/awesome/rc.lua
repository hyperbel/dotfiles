...
globalkeys = gears.table.join(
   ...
   awful.key({ modkey }, "b", function ()
       awful.util.spawn("bash /home/lia/code/git/gh/scripts/bluetooth.sh", false)
   end,
              {description = "Bluetooth connection script", group = "custom"}),

    awful.key({modkey }, "Escape", function ()
        awful.util.spawn("slock", false)
    end, {description = "lock screen", group = "custom"}),
    awful.key({modkey, "Shift" }, "Escape", function ()
        awful.util.spawn("systemctl suspend && slock", false)
    end,{description = "suspend and lock screen", group = "custom"}),
...
awful.spawn.with_shell("eval `ssh-agent` && ssh-add ~/.ssh/ansible-management")
-- set screenlayout
awful.spawn.with_shell("bash ~/.screenlayout/third.sh")
